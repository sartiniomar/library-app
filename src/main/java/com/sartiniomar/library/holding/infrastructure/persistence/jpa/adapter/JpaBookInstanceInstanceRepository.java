...
import com.sartiniomar.library.holding.infrastructure.persistence.jpa.mapper.BookInstanceMapper;
import com.sartiniomar.library.holding.infrastructure.persistence.jpa.model.BookInstanceEntity;
import com.sartiniomar.library.holding.infrastructure.persistence.jpa.repository.SpringDataBookInstanceRepository;
...
@Repository
public class JpaBookInstanceInstanceRepository implements BookInstanceRepository {

  private final SpringDataBookInstanceRepository jpaRepo;

  public JpaBookInstanceInstanceRepository(SpringDataBookInstanceRepository jpaRepo) {
