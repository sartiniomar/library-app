...
import com.sartiniomar.library.lending.infrastructure.persistence.jpa.adapter.JpaHoldRepository;
...
@DataJpaTest
@Import(JpaHoldRepository.class)
public class JpaHoldRepositoryTest {

  @Autowired
  private JpaHoldRepository repository;
