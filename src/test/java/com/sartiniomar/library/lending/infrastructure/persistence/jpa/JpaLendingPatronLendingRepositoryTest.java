...
import com.sartiniomar.library.lending.infrastructure.persistence.jpa.adapter.JpaLendingPatronRepository;
...
@DataJpaTest
@Import(JpaLendingPatronRepository.class)
class JpaLendingPatronLendingRepositoryTest {

  @Autowired
  private JpaLendingPatronRepository repository;
